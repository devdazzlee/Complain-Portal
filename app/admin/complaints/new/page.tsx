...
import { ProblemType, Priority, ComplaintStatus } from '../../../types';
...
export default function NewComplaintPage() {
  ...
  const [formData, setFormData] = useState({
    dswId: '',
    clientId: '',
    typeOfProblem: '' as string, // Store type ID as string
  ...
  return (
    <Layout role="admin">
      <div className="max-w-3xl mx-auto px-4 md:px-5 sm:px-6 w-full min-w-0 overflow-x-hidden">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3" style={{ color: '#E6E6E6' }}>Create New Complaint</h1>
          ...
          <div className="w-full min-w-0">
                  ...
                  {attachments.map((file, index) => (
                    <div key={index} className="relative rounded-lg p-3" style={{ backgroundColor: '#2A2B30', border: '2px solid #E6E6E6' }}>
                      <button
                        ...
                        className="absolute top-1 right-1 p-1 hover:opacity-70 transition-opacity"
                        style={{ color: '#FFFFFF' }}
            ...
            <div className="relative">
              ...
              <button
                ...
                onClick={() => fileInputRef.current?.click()}
                disabled={uploading}
                className="absolute right-2 sm:right-3 md:right-4 top-1/2 transform -translate-y-1/2 cursor-pointer transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center min-w-[36px] sm:min-w-[40px] md:min-w-[44px] min-h-[36px] sm:min-h-[40px] md:min-h-[44px]"
                style={{ 
                  color: '#E6E6E6'
                }}
