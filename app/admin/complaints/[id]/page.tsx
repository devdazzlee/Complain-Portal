    ...
    <Layout role="admin">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 md:mb-8">
          ...
          <p className="text-base md:text-xl" style={{ color: '#E6E6E6', opacity: 0.8 }}>Complaint details and management.</p>
        </div>
        ...
        {isRefused && complaint.refusalReasons && (
          <div className="rounded-lg p-6 md:p-8 mb-6" style={{ backgroundColor: '#2A2B30' }}>
            <h2 className="text-2xl md:text-3xl font-bold mb-6" style={{ color: '#E6E6E6' }}>Refusal Reasons</h2>
        ...
        {complaint.rating && (
          <div className="rounded-lg p-6 md:p-8 mb-6" style={{ backgroundColor: '#2A2B30' }}>
            <h2 className="text-2xl md:text-3xl font-bold mb-4" style={{ color: '#E6E6E6' }}>Rating</h2>
