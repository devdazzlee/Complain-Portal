...
export default function AdminDashboard() {
  const { complaints, getDashboardStats, users } = useApp();
    ...
    <Layout role="admin">
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold mb-3" style={{ color: '#E6E6E6' }}>Admin Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-10">
        <div 
          ...
          style={{ transform: 'translateZ(0)' }}
        >
          <h3 className="font-semibold text-[#E6E6E6] text-lg mb-2 text-center">Total Users</h3>
          <p className="font-bold text-white !text-4xl md:text-6xl leading-none">{totalUsers}</p>
        </div>
        <div 
          ...
          style={{ transform: 'translateZ(0)' }}
        >
          <h3 className="font-semibold text-[#E6E6E6] text-lg mb-2 text-center">Providers</h3>
          <p className="font-bold text-white !text-4xl md:text-6xl leading-none">{totalProviders}</p>
        </div>
        <div 
          ...
          style={{ transform: 'translateZ(0)' }}
        >
          <h3 className="font-semibold text-[#E6E6E6] text-lg mb-2 text-center">Admins</h3>
          <p className="font-bold text-white !text-4xl md:text-6xl leading-none">{totalAdmins}</p>
        </div>
      </div>
      ...
      <div className="rounded-lg p-6 md:p-8" style={{ backgroundColor: '#2A2B30' }}>
        <div className="mb-6">
          <h2 className="text-3xl font-bold" style={{ color: '#E6E6E6' }}>All Complaints</h2>
        </div>
