  ...
  return (
    <Layout role="customer">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-10">
        <div className="rounded-lg p-6 md:p-8 flex flex-col justify-center items-center bg-[#2AB3EE] min-h-[160px]">
        ...
        <div className="rounded-lg p-6 md:p-8 flex flex-col justify-center items-center bg-[#009200] min-h-[160px]">
        ...
        <div className="rounded-lg p-6 md:p-8 flex flex-col justify-center items-center bg-[#FF3F3F] min-h-[160px]">
